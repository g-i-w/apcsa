...
class GraphViewGUI extends JPanel implements GraphView {
  ...
  public void setResolution ( int x, int y ) {
    xResolution = x;
    yResolution = y;
    // set the ScreenTransformation resolution
    screen.setResolution( xResolution, yResolution );
